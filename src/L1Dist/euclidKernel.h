...
void launchEuclidKernel(cudaStream_t stream, dim3 blocksPerGrid, dim3 threadsPerBlock, float *in, float* out, int numReads, int numSeeds, int stageX, int stageY, int arrayDim);
